...
summary: Configure the EDA Projects dashboard by adding tags to collect metrics. Customize filters with single or multi-selection options to meet your business needs. 
---
