...
It helps you monitor storage usage for capacity allocated, capacity used, throughput, and IOPS. For proactive latency performance monitoring, see link:learn-latency-monitoring.html[Learn about latency monitoring]. 
