...
---
= Monitor volume latency for EDA in NetApp Workload Factory
:icons: font
:imagesdir: ./media/
...
For best practices on analyzing latency trends, see link:task-analyze-latency-trends.html#graph-interpretation-tips[Graph interpretation tips].
