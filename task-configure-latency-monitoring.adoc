...
If you haven't configured AWS credentials, refer to link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[Add AWS credentials^].
...
For instructions on creating and associating links, refer to link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-link.html[Create a link^].

=== Turn on AI settings

If your account admin has turned off AI features, you'll see a message and won't be able to use AI analysis. Contact your administrator or refer to link:https://docs.netapp.com/us-en/workload-setup-admin/manage-genai-features.html[learn about AI administration^].
...
To enable notifications, refer to link:https://docs.netapp.com/us-en/workload-setup-admin/configure-notifications.html#wf-console-email-notifications[Configure notification settings].
