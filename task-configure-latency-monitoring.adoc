...
If your account admin has turned off AI features, you'll see a message and won't be able to use AI analysis. Contact your administrator or https://docs.netapp.com/us-en/workload-setup-admin/manage-genai-features.html[learn about AI administration^].
