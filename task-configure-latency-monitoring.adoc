...
(Optional) You can enable AI analysis by configuring your own Amazon Bedrock model ARN in Workload Factory settings. Depending on your account setup, AI analysis might also be available through NetApp-managed AI credits.

AI analysis is unavailable if your monthly NetApp AI credit limit has been reached or your administrator has disabled AI features.
